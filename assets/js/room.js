...
[
    {
        ...
        "booking": "You chose to choose your lodging on the fly. You can't typically book bargain accommodation in advance, but most of the time you get a decent roof over your head. Just start looking before sunset for those signs or the callers at the public transportation sites."
    },
    {
        "name" : "camping",
        "label": "Camping",
        "details": "There are over 300 registered campsites in Croatia with 90% close to a beach. Glamping may be a more appropriate term for caming in Croatia as many sites have permanent bungalows and tents on site. Some of the larger campsites include restaurants, sports facilities, laundries, and general store too.",
    ...
    },
    {
        "name": "hostel",
        "label":"Youth Hostels",
        "details": "Dormitory style living with strict university schedules to boutique private rooms are popping up all over Croatia.",
        "booking":"Book your youth hostel experience with one of the many registered hostiles at <a href='https://www.hfhs.hr' target='_blank'>www.hfhs.hr</a>."
    },
    {
        "name" : "hotels",
        ...
        "booking": "You opted to have a clean private roof over you head. Use the Croatian registry to book you spot at <a href='https://www.omh.hr' target='_blank'>www.omh.hr</a>."
    },
    {
        "name" : "homes",
        "label": "Private Homes",
        "details": "Need an apartment or private house with the ability to cook your own meals. And want places vetted by your peers?",
        "booking" : "Many villas and apartments are listed both on <a href ='https://www.omh.hr' target='_blank'>the Croatia apartment and hotel website</a> as well as <a href='https://www.airbnb.com' target=_blank'>abnr</a>."
    },
    {
        "name" : "unique",
        "label": "Weird & Wonderful",
        "details": "Can you, would you want to sleep in a Lighthouse, Treehouse, Wine Barrel, Castle or Boat?",
        "booking": "You adventurous soul, you have opted to find the most interesting of places to rest your head. <a href='https://www.chasingthedonkey.com/weird-accommodation-in-croatia/' target='_blank'>This article</a> has a short list of how to reserve your spot. "
    }
];
